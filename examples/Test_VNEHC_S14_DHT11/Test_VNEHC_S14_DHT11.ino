...
*/
#include "DHT11_Test_Lib.h"

Task_VNEHC_Test Task_VNEHC_Test1;
DHT11_Test_Lib DHT11_Test_Lib1;
...
void setup() {
  ...
  Serial.println();
  Serial.println();
  Serial.println(F("Start test S14 DHT11"));
  ...
  // DHT11_Test_Lib1.setup(&Task_VNEHC_Test1, &Serial, PIN_PORT4_RX, 9);
  DHT11_Test_Lib1.setup(&Task_VNEHC_Test1, &Serial);
  DHT11_Test_Lib1.setEnDebug(0);
  DHT11_Test_Lib1.start();
